...
const genderVideoGames = videogames.filter((videogame) =>
  videogame.genders.includes('RPG')
)
console.log(genderVideoGames)
const sumScoresRPG = genderVideoGames.reduce(
  (accumulator, genderVideoGame) => accumulator + genderVideoGame.score,
  0
)
const mediaScoreRPG = sumScoresRPG / genderVideoGames.length
